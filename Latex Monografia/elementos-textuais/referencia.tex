\chapter{Referencia de objetos}\label{chp:LABEL_CHP_7}

\section{Tables}\label{sec:LABEL_CHP_7_SEC_A}
...
\section{Images}\label{sec:LABEL_CHP_7_SEC_B}
...
\section{Equations}\label{sec:LABEL_CHP_7_SEC_C}
...
\section{Listings}\label{sec:LABEL_CHP_7_SEC_D}
...
\section{References}\label{sec:LABEL_CHP_7_SEC_E}
\begin{itemize}
