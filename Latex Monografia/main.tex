...
\title{Comparação de resolvedores SMT como geradores de exemplos para modelagens B}

% autor é obrigatório; máximo de 3 autores
\author{Vítor Luís dos Santos Trindade}{\input{elementos-pretextuais/agradecimentos}}
...
\advisor[Prof.]{Anamaria Martins Moreira,~Ph.D.}{}
...
\input{elementos-textuais/dados-preeliminares}
\pagebreak
